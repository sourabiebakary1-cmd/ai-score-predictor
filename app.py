...
st.markdown("<p style='text-align: center; color: gray;'>EA Sports FC 25 - Top 3 Scores les plus probables</p>", unsafe_allow_html=True)
...
# Fonction intelligente (semi-réaliste)
